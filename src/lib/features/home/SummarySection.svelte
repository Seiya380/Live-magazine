  ...
  const summaryItems = [
    {
      num: 1,
      title: "Edito",
      comment: "The beginning is always a good place to start.",
    },
    { num: 4, title: "Qui suis-je ?", comment: "The eternal question." },
    { num: 5, title: "Si j’étais ?", comment: "A game of hypotheticals." },
    {
      num: 7,
      title: "Napenda / Sipendi",
      comment: "Love and... not love? Intriguing.",
    },
    { num: 9, title: "Alter", comment: "Who represent me the most." },
    {
      num: 11,
      title: "Ouverture",
      comment: "My bold move who changed my life.",
    },
    {
      num: 12,
      title: "Mon Glossaire",
      comment: "Defining the terms of my reality.",
    },
    { num: 13, title: "Je suis unique", comment: "A point of view." },
    { num: 14, title: "Cassandre", comment: "A discours of my girlfriend" },
    {
      num: 15,
      title: "L’enfant que je suis",
      comment: "The past is never far.",
    },
    {
      num: 17,
      title: "Tableau de vision",
      comment: "Ok so this one is really interesting. No?",
    },
    {
      num: 18,
      title: "Pandora’s box",
      comment: "Are you sure you want to open that?",
    },
    {
      num: 19,
      title: "Manifeste",
      comment: "How I want to see a company and how I work.",
    },
    {
      num: 20,
      title: "Pourquoi oser ?",
      comment: "My futur dreams and project.",
    },
    { num: 21, title: "Création visuelle", comment: "Interesting." },
  ];
